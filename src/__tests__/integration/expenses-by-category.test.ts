...
describe("test expenses by category util fn", () => {
    ...
    it("should return an array of 3 categories", async () => {
        ...
        if (!needCategory) throw new Error("TestDB Setup Error: Needs Category not found")
        ...
        const testStartingTotal = Math.round(((randomAmount * needCategory.percentageSplit.toNumber()) + Number.EPSILON) * 100) / 100
